...
BtnGetConsult.addEventListener('click',function(){
    ...
    if((MobileNumberModalWindowGetConsult.value[0]==8 && MobileNumberModalWindowGetConsult.value.length<12 && MobileNumberModalWindowGetConsult.value.length>10) ||(MobileNumberModalWindowGetConsult.value[0]==7 && MobileNumberModalWindowGetConsult.value.length<12 && MobileNumberModalWindowGetConsult.value.length>10)||(MobileNumberModalWindowGetConsult.value[0]=='+' && (MobileNumberModalWindowGetConsult.value)[1]=='7' && MobileNumberModalWindowGetConsult.value.length<13 && MobileNumberModalWindowGetConsult.value.length>11)){
        ...
        console.log('Номера для получения консультации');
...
BtnGetBankruptcy.addEventListener('click',function(){
    ...
    if((MobileNumberGetBankruptcy.value[0]==8 && MobileNumberGetBankruptcy.value.length<12 && MobileNumberGetBankruptcy.value.length>10) ||(MobileNumberGetBankruptcy.value[0]==7 && MobileNumberGetBankruptcy.value.length<12 && MobileNumberGetBankruptcy.value.length>10)||(MobileNumberGetBankruptcy.value[0]=='+' && (MobileNumberGetBankruptcy.value)[1]=='7' && MobileNumberGetBankruptcy.value.length<13 && MobileNumberGetBankruptcy.value.length>11)){
        ...
        console.log('Номера для получения банкротства');
...
// let =document.getElementById('');
// // Ссылка для открытия модального окна получения  фиксации заявки
// let =document.getElementById('');
// // Кнопка для закрытия модального окна получения  фиксации заявки
// let =document.getElementById('');
// // поле для ввода мобильного телефона
// let =document.getElementById('');
// // кнопка для заявки получения фиксации заявки
// let =document.getElementById('');
// // номера телефонов для предоставления  фиксации заявки
// let =document.getElementById('');
// // Кнопка для скрытия модальных окон и очищения инпута получения  фиксации заявки
// let =document.getElementById('');
// // Функция открытия модального окна получения  фиксации заявки
// let =document.getElementById('');
// // Функция закрытия модального окна получения  фиксации заявки
// let =document.getElementById('');
// // Функция отправки номера в массив при прохождении валидации получения  фиксации заявки
// let =document.getElementById('');
//====================================================================================================Модальное окно получения чек листа=============================================================================
// // Модальное окна получения  чек листа
// let =document.getElementById('');
// // Ссылка для открытия модального окна получения  чек листа
// let =document.getElementById('');
// // Кнопка для закрытия модального окна получения  чек листа
// let =document.getElementById('');
// // поле для ввода мобильного телефона
// let =document.getElementById('');
// // кнопка для заявки получения чек листа
// let =document.getElementById('');
// // номера телефонов для предоставления  чек листа
// let =document.getElementById('');
// // Кнопка для скрытия модальных окон и очищения инпута получения  чек листа
// let =document.getElementById('');
// // Функция открытия модального окна получения  чек листа
// let =document.getElementById('');
// // Функция закрытия модального окна получения  чек листа
// let =document.getElementById('');
// // Функция отправки номера в массив при прохождении валидации получения  чек листа
// let =document.getElementById('');
//====================================================================================================Модальное окно фиксации заявки=============================================================================
// // Модальное окна получения  фиксации заявки
// let =document.getElementById('');
